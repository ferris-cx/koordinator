...
func SetDeviceAllocations(obj metav1.Object, allocations DeviceAllocations) error {
	klog.V(4).Info("SetDeviceAllocations: allocations: %s", allocations)
	...
	annotations[AnnotationDeviceAllocated] = string(data)//TODO 分配结果写到Pod的Annotations上
	obj.SetAnnotations(annotations)
	klog.V(4).Info("SetDeviceAllocations: obj: %s", obj)
	return nil
}
