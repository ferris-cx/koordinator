...
const (
	...
	// VFAnnotationsInject injects vf allocated Annotations info according to allocate result from koord-scheduler.
	//
	// owner: @stone
	// alpha: v0.1
	RDMAEnvInject featuregate.Feature = "RDMAEnvInject"
)
